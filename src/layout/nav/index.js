            ...
            <Menu
             ...
             >
                <SubMenu
                    ...
                    >
                        <Menu.Item key="2"><a href="#/discuss">帖子管理</a></Menu.Item>
                    </SubMenu>
                    <SubMenu
                        key="sub3"
                        title={<span><Icon type="dashboard" /><span>文章</span></span>}
                    >
                        <Menu.Item key="3"><a href="#/article">文章管理</a></Menu.Item>
                    </SubMenu>
                    <SubMenu
                        key="sub4"
                        title={<span><Icon type="dashboard" /><span>闲置</span></span>}
                    >
                        <Menu.Item key="4"><a href="#/shop">商品管理</a></Menu.Item>
                    </SubMenu>
                    <SubMenu
                        key="sub5"
                        title={<span><Icon type="dashboard" /><span>相册</span></span>}
                    >
                        <Menu.Item key="5"><a href="#/picture">相册管理</a></Menu.Item>
                    </SubMenu>
            </Menu>
        )
    }
